angular.module('cresud.cdp.gruposEmpresa', [
    'cresud.cdp.gruposEmpresa.ctrl.list',
    'cresud.cdp.gruposEmpresa.ctrl.edit',    
    'cresud.cdp.navigation.base',     
    'cresud.cdp.service.base',
    'cresud.cdp.service.gruposEmpresa',
    ...
    function ($routeProvider, $locationProvider, $httpProvider) {
        ...
        $routeProvider.when('/', {
            templateUrl: 'gruposEmpresa/list',
            controller: 'listCtrl'
        });
              
        $routeProvider.when('/create', {
            templateUrl: 'gruposEmpresa/edit',
            controller: 'editCtrl'
        });
