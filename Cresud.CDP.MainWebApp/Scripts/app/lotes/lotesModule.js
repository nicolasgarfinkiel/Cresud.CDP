angular.module('cresud.cdp.lotes', [
    'cresud.cdp.lotes.ctrl.list',
    'cresud.cdp.lotes.ctrl.edit',
    'cresud.cdp.service.lotes',
    ...
    function ($routeProvider, $locationProvider, $httpProvider) {
        ...
        $routeProvider.when('/', {
            templateUrl: 'lotes/list',
            controller: 'listCtrl'
        });
              
        $routeProvider.when('/create', {
            templateUrl: 'lotes/edit',
            controller: 'editCtrl'
        });
