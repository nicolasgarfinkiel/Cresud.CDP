angular.module('cresud.cdp.establecimientos', [
    'cresud.cdp.establecimientos.ctrl.list',
    'cresud.cdp.establecimientos.ctrl.edit',
    ...
    function ($routeProvider, $locationProvider, $httpProvider) {
        ...
        $routeProvider.when('/', {
            templateUrl: 'establecimientos/list',
            controller: 'listCtrl'
        });
              
        $routeProvider.when('/create', {
            templateUrl: 'establecimientos/edit',
            controller: 'editCtrl'
        });
